    # STF STP dynamics - 使用Reproduce Figure 2: Single-Layer CANN Experiments (JAX 向量化加速版)
================================================================
...
def main():
    ...
    std_plot_data = {
        ...
        'stim_neuron': std_recording['s1plot_fig2_single_layer_v2lta': std_results['curve_binned']['delta'],
